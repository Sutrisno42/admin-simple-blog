...
const formatDate = (data, label = false) => {
  if (data) {
...
<template>
  <div v-if="small" :class="'row ' + rowClass">
    <div class="col-4">
      <a
        class="badge bg-success waves-effect waves-light"
        @click="
          props.perDays ? prevDate() : props.perYear ? prevYear() : prevMonth()
        "
      >
        <i class="ri-arrow-left-s-line label-icon align-middle fs-14 me-2"></i>
      </a>
    </div>
    <div class="col-4 text-center">
      <h4 class="text-muted fs-15 text-uppercase">
        {{ currentMonthLabel }}
      </h4>
      <h6 class="text-muted text-uppercase" v-if="props.noData">(NO DATA)</h6>
    </div>
    <div class="col-4 text-right" style="text-align: right">
      <a
        ...
        class="badge bg-success waves-effect waves-light"
        @click="
          props.perDays ? nextDate() : props.perYear ? nextYear() : nextMonth()
        "
      >
        <i class="ri-arrow-right-s-line label-icon align-middle fs-14 ms-2"></i>
      </a>
    </div>
  </div>
  <div v-else :class="'row ' + rowClass">
    <div class="col-4">
      <button
    ...
    <div class="col-4 text-center">
      ...
      <h6 class="pt-1 text-muted text-uppercase" v-if="props.noData">
        (NO DATA)
      </h6>
    </div>
    <div class="col-4 text-right" style="text-align: right">
